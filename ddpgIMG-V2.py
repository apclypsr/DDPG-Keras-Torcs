...
def playGame(train_indicator=1):    #1 means Train, 0 means simply Run
    ...
    BATCH_SIZE = 32
    GAMMA = 0.99
    TAU = 0.0005     #Target Network HyperParameters
    ...
    for i in range(episode_count):
        ...
        imgfinal = np.zeros((1, 160, 160, 12), dtype=np.int32)
        ...
        for j in range(max_steps):
            ...
            if len(imglst) == 4:
                ...
                # print(np.shape(imgfinal))

                imgfinal = np.reshape(imgfinal, (4, 160, 160, 3))
                ...
                imgfinal = np.reshape(imgfinal, (1, 160, 160, 12))
